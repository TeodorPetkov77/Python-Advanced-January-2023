...
for row in range(n):
    ...
    if "T" in matrix[row]:
        tunnel_exit[0], tunnel_exit[1] = row, matrix[row].index("T")
...
while direction != "End":
    ...
    if matrix[car_pos[0]][car_pos[1]] == "F":
        ...
        matrix[tunnel_exit[0]][tunnel_exit[1]] = "."
        car_pos[0], car_pos[1] = tunnel_exit[0], tunnel_exit[1]
    else:
        distance += 10
    direction = input()
...
# right
# up
# End	Racing car 01 finished the stage!
# Distance covered 80 km.
# .....
# .....
# .....
# .....
# ..C..	The race car starts moving from position[0,0].
